...
def new_project(project_name, deadline, start_date, user_id):
    ...
    if stdate > dline:
        ...
        dbs.create_project(project_name, user_id, start_date, deadline)
...
def check_proj_users(project_name, user_id):
    dbs.add_user_to_project(project_name, user_id)

def specific_proj(project_id):
    return dbs.fetch_project(project_id)

def remove_user(project_id, user_id):
    dbs.remove_user_from_project(project_id,user_id)

def edit_proj(project_id, project_name, start_date, deadline):
    dbs.edit_project(project_id, project_name, start_date, deadline)
